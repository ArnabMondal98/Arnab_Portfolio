  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center px-6 pt-20">
      <div className="mx-auto max-w-5xl text-center">
        ...
        {/* Summary */}
        <p className="mx-auto mt-6 max-w-3xl text-lg text-muted-foreground whitespace-pre-line opacity-0 animate-fade-in-up animate-delay-300 md:text-lg">
          {profile.summary}
        </p>
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 opacity-0 animate-fade-in-up animate-delay-400 sm:flex-row">
          ...
          <a
            href="/ArnabMondal_Europe_DataAnalytics_Resume.pdf"
            download
